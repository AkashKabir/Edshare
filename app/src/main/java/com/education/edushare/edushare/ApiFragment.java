...
public class ApiFragment extends Fragment {
    ...
    public void analyzeEntities(String text) {
        Log.d(TAG, "analyzeEntities: "+text);
        try {
            Log.d(TAG, "analyzeEntities: try block");
        ...
        Log.d(TAG, "analyzeEntities: out of try block");
    }

    public void analyzeSentiment(String text) {
        Log.d(TAG, "analyzeSentiment: "+text);
        try {
            Log.d(TAG, "analyzeSentiment: try block");
            mRequests.add(mApi
                    .documents()
        ...
        Log.d(TAG, "analyzeSentiment: out of try block");
    }

    public void analyzeSyntax(String text) {
        Log.d(TAG, "analyzeSyntax: "+text);
        try {
            Log.d(TAG, "analyzeSyntax: try block");
            mRequests.add(mApi
                    .documents()
        ...
        Log.d(TAG, "analyzeSyntax: out of try block");
    }
