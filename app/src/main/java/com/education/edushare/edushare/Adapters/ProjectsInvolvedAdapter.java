...
public class ProjectsInvolvedAdapter extends RecyclerView.Adapter<ProjectsInvolvedAdapter.MyViewHolder> {
    ArrayList<DashBoardModel> arrayList = new ArrayList<>();
    ArrayList<DashBoardModel> backuParrayList = new ArrayList<>();
    Context context;
    Typeface typeface ;
    private static ProjectsInvolvedAdapter.ClickListener clickListener;

    public ArrayList<DashBoardModel> contactListFiltered = new ArrayList<>();

    public ProjectsInvolvedAdapter(Context context, ArrayList<DashBoardModel> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ProjectsInvolvedAdapter.MyViewHolder(itemView);
    }
    ...
    public void setOnItemClickListener(ProjectsInvolvedAdapter.ClickListener clickListener) {
        ProjectsInvolvedAdapter.clickListener = clickListener;
    }
